...
public class UserController {
    ...
    public ResponseEntity<String> registerUser(@Valid @RequestBody UserDto.SignupRequest signupRequestDto, BindingResult bindingResult) {
    ...
    @GetMapping("/search")
    public List<User> searchUsers(@RequestParam String searchedText) {
        return userService.searchUsersByFirstNameLastNameUsername(searchedText);
    }
