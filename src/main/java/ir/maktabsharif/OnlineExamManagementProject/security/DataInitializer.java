...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Authority viewStudentExamAnswers = createAuthority("VIEW_STUDENT_EXAM_ANSWERS");

        Authority viewCompletedExam = createAuthority("VIEW_COMPLETED_EXAM");
        Authority giveScore = createAuthority("GIVE_SCORE");
        ...
        teacherRole.getAuthorities().addAll(Set.of(
                ...
                viewStudentExamAnswers,viewCompletedExam,giveScore
        ));
        ...
        studentRole.getAuthorities().addAll(Set.of(
                viewStudentCourses,viewAvailableExams,getExamAccess,viewStudentExamAnswers
        ));
